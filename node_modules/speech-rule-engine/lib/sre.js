...
sre.SpeechGeneratorUtil.retrieveSpeech=function(a,b){var c=null;sre.Engine.getInstance().cache&&(c=sre.SpeechRuleEngine.getInstance().getCache(b.id.toString()));c||(c=sre.SpeechGeneratorUtil.recomputeSpeech(a,b));return sre.AuralRendering.getInstance().markup(c)};sre.SpeechGeneratorUtil.addSpeech=function(a,b){var c=sre.SpeechGeneratorUtil.retrieveSpeech(a,b);a.setAttribute(sre.EnrichMathml.Attribute.SPEECH,c)};
sre.SpeechGeneratorUtil.addPrefix=function(a,b){var c=sre.SpeechGeneratorUtil.retrievePrefix(b);c&&a.setAttribute(sre.EnrichMathml.Attribute.PREFIX,c)};sre.SpeechGeneratorUtil.retrievePrefix=function(a){a=sre.SpeechGeneratorUtil.computePrefix_(a);return sre.AuralRendering.getInstance().markup(a)};
