...
The Software and Data Carpentry initiatives have been motivated by the above referenced concerns and some of its teachers have worked on a set of recommendations (best practices) in a scientific paper [**"Ten Simple Rules for Digital Data Storage"**](journal.pcbi.1005097.PDF).
